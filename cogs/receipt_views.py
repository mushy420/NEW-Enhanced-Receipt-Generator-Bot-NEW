...
from ui.receipt_views import ReceiptView

# Setup logging
logger = logging.getLogger('receipt_commands')

class ReceiptCommandsCog(commands.Cog):
    ...
    async def on_ready(self):
        ...
        logger.info("Receipt Generator commands cog is ready")
    ...
    async def receipt(self, interaction: discord.Interaction):
        ...
        logger.info(f"Receipt generation started by {user_id}")

async def setup(bot: commands.Bot):
    """Add the cog to the bot."""
    await bot.add_cog(ReceiptCommandsCog(bot))
